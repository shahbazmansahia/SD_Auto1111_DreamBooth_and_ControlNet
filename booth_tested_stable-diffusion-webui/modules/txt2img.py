...
def txt2img(id_task: str,
    ...
    outpath = opts.outdir_txt2img_samples + '/' + prompt.split(',')[0] # default value for txt2img "outputs/txt2img-images"
    ## Custom Code ends here:

    p = processing.StableDiffusionProcessingTxt2Img(
        sd_model=shared.sd_model,
        #outpath_samples=opts.outdir_samples or opts.outdir_txt2img_samples, # default value
        ## Custom Code Starts here --Shahbaz
